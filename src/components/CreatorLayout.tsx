...
import {
  ...
  User, Settings, MessageSquare, Bell, LogOut, Menu, ChevronRight,
} from 'lucide-react'
...
const NAV = [
  ...
  { icon: FileText,        label: 'My Collabs',   href: '/creator/collabs' },
  ...
  const Sidebar = (
    <aside className="flex flex-col h-full bg-gray-900 border-r border-gray-800 w-60 flex-shrink-0">
      <div className="px-5 py-5 flex items-center gap-3 border-b border-gray-800">
        ...
        <span className="ml-auto text-xs bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full font-medium">Creator</span>
      </div>
