...
const FILTERS = ['All', 'In Progress', 'Revision', 'Delivered', 'Completed', 'Pending']

const STATUS_MAP: Record<string, string> = {
  'All': '', 'In Progress': 'in_progress', 'Revision': 'revision_requested',
  'Delivered': 'delivered', 'Completed': 'completed', 'Pending': 'pending',
}
...
const STATUS_LABELS: Record<string, string> = {
  ...
  delivered: 'Delivered', completed: 'Completed', pending: 'Pending', cancelled: 'Cancelled',
}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-500">
                      ...
                      {milestones.length > 0 && <span>{paidMilestones}/{milestones.length} milestones</span>}
                    </div>
                  </div>
